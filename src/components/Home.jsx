    ...
    return (
        <div name='home' className='bg-[#EAEBED] w-full h-screen'>
            <div className='max-w-[700px] mx-auto px-8 flex flex-col justify-center h-full'>
                ...
                <h1 className='text-8xl sm:text-9xl font-bold text-black mb-4'>Henry Le</h1>
                <h2 className='text-3xl sm:text-5xl font-bold text-[#7b5675]'>I build things that people use and play with for mobile and web.</h2>
                <div>
