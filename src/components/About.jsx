        ...
        <section name='about' className='bg-[#EAEBED] w-full h-screen'>
            <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
                ...
                <div>
                    ...
                    <p className='py-4 w-full'>Proin mattis nulla eu nulla efficitur, eu aliquam sem tempus. Vivamus tristique orci felis, eu dignissim mauris lacinia vitae. Nullam vehicula feugiat fringilla. Maecenas euismod tristique diam, quis convallis mi sagittis nec. Aenean sodales imperdiet vulputate. Fusce accumsan nulla eu laoreet bibendum. Duis elementum, nunc ut eleifend ullamcorper, magna est consequat nisl, vel vestibulum nisi metus sit amet eros.</p>
